...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'background': '#000000', 'primaryColor': '#FFFFFF', 'edgeLabelBackground':'#FFFFFF', 'tertiaryColor': '#FFFFFF', 'primaryTextColor': '#FFFFFF', 'labelTextColor': '#FFFFFF'}}}%%
sequenceDiagram
